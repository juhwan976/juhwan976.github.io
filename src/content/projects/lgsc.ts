...
export const lgsc: ProjectContent = {
  ...
  highlights: [
    { label: 'MAU', value: '7,000명', numericValue: 7000, suffix: '명' },
    { label: '지원 제품군', value: '192개', numericValue: 192, suffix: '개' },
    {
      label: '비정상 종료 발생률',
      value: '약 8% → 약 1%',
      note: '내부 측정 기준',
  ...
  challenges: [
    ...
    },
    {
      ...
      results: ['192개 제품군이 하나의 공통 구조를 공유'],
    },
  ],
  decisions: [
    {
    ...
    },
    {
      ...
      title: '파싱 구조 저장 DB 설계',
      body: [
        '사업부와 제품군마다 다른 파싱 구조를 저장할 수 있는 데이터베이스를 설계했습니다.',
      ],
      diagram: {
        type: 'flow',
        title: 'Offline Log Sync',
        steps: [
          { title: '제품 로그 수신', detail: 'Wi-Fi Direct / Socket' },
          { title: '로컬 저장', detail: 'Drift / SQLite, 행 단위 기록' },
          { title: '네트워크 복구 감지', detail: '전송 완료·재시도 상태 관리' },
          { title: '서버 동기화', detail: '순차 전송' },
        ],
      },
    },
  ],
  results: [
    'MAU 7,000명을 기록했습니다.',
    '지원 제품군 192개에 대응했습니다.',
    '비정상 종료 발생률이 약 8%에서 약 1%로 개선됐습니다. (내부 측정 기준)',
    '실제 서비스로 배포됐습니다.',
    '오프라인 로그 동기화 구조를 자체 구현했습니다.',
  ],
  reflection: {
    items: [
      {
  ...
  gallery: [
    {
      ...
      alt: '일부 데이터를 블러 처리한 실제 앱 화면',
      caption: '실제 화면 (일부 데이터 블러 처리)',
      placeholderLabel: 'App Screen',
    },
    {
      kind: MediaKinds.IMAGE,
      src: IMAGE_PLACEHOLDER,
      alt: '제품 연결 흐름 다이어그램',
      caption: '제품 연결 흐름',
      placeholderLabel: 'Connection Flow',
    },
    {
      kind: MediaKinds.IMAGE,
      src: IMAGE_PLACEHOLDER,
      alt: '오프라인 로그 동기화 다이어그램',
      caption: '오프라인 동기화 다이어그램',
      placeholderLabel: 'Offline Sync',
    },
    {
      kind: MediaKinds.IMAGE,
      src: IMAGE_PLACEHOLDER,
      alt: '추상화된 시스템 아키텍처 다이어그램',
      caption: '추상화된 시스템 아키텍처',
  ...
  cardMedia: {
    ...
    src: IMAGE_PLACEHOLDER,
    alt: 'LGSC 앱 화면',
    placeholderLabel: 'LGSC',
  },
  scene: {
    title: '192개 제품군을\n하나의 구조로.',
    summary: '인터넷이 끊겨도 가전의 상태를 확인하고\n제어할 수 있는 모바일 앱.',
    stats: ['192 Products', '7K MAU', 'Crash 8% → 1%'],
    coreTech: ['Flutter', 'Dart', 'RxDart', 'Drift', 'Socket'],
    theme: SceneThemes.APPLIANCE,
  },
};
