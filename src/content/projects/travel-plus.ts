...
export const travelPlus: ProjectContent = {
  ...
  team: '4인 개발',
  tags: ['프로젝트 리드', '4인 개발', 'Performance'],
  tech: [
    'React',
    'TypeScript',
    'webOS',
  ...
  highlights: [
    ...
    { label: 'QA', value: '검증 가능한 수준으로 안정화' },
  ],
  challenges: [
    {
      id: 'performance',
    ...
    },
    {
      ...
      results: [
        '구현 가능한 디자인 대안이 승인됐습니다.',
        '사용성과 시각적 완성도를 함께 고려한 결과물을 확보했습니다.',
      ],
    },
  ],
  decisions: [
    ...
    },
    {
      ...
      diagram: {
        ...
        steps: [
          ...
          { title: 'Enact 기반 방식 검토', detail: 'webOS 기본 포커스 환경과 호환' },
  ...
  gallery: [
    {
      ...
      alt: '실제 서비스 화면',
      caption: '실제 서비스 화면',
      placeholderLabel: 'Service Screen',
    },
    {
      kind: MediaKinds.VIDEO,
      src: VIDEO_PLACEHOLDER,
      alt: 'TV 앱 조작 화면 녹화 영상',
      caption: '화면 녹화 영상',
    ...
    },
    {
      kind: MediaKinds.IMAGE,
      src: IMAGE_PLACEHOLDER,
      alt: 'TV 포커스 이동 흐름 다이어그램',
      caption: 'TV 포커스 이동 흐름',
      placeholderLabel: 'Focus Flow',
    },
    {
      kind: MediaKinds.IMAGE,
      src: IMAGE_PLACEHOLDER,
      alt: '컴포넌트 구조 개선 다이어그램',
      caption: '컴포넌트 구조 개선 다이어그램',
      placeholderLabel: 'Component Structure',
    },
  ],
  cardMedia: {
    kind: MediaKinds.IMAGE,
    src: IMAGE_PLACEHOLDER,
    alt: 'Travel+ TV 앱 화면',
    placeholderLabel: 'Travel+',
  },
  scene: {
    title: '3분의 로딩을\n10초로.',
    summary: '느린 TV 하드웨어에서 쓸 수 있게\n다시 설계한 webOS 앱.',
    stats: ['3 min → 10 sec', '1 Month Renewal', 'webOS TV'],
    coreTech: ['React', 'TypeScript', 'webOS', 'SCSS', 'Redux Toolkit'],
    theme: SceneThemes.TV,
  },
};
